...
class Weather(Button):
    ...
    def _fetch_weather_thread(self, user_data):
        ...
        url = f"https://wttr.in/?format=%c+%t&location={LOCATION}" if not data.VERTICAL else f"https://wttr.in/?format=%c&location={LOCATION}"

        tooltip_url = f"https://wttr.in/?format=%l:+%C,+%t+(%f),+Humidity:+%h,+Wind:+%w&location={LOCATION}"
